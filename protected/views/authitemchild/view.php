...
$this->menu=array(
	...
	array('label'=>'Update Authitemchild', 'url'=>array('update', 'parent'=>$model->parent,'child'=>$model->child)),
	array('label'=>'Delete Authitemchild', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','parent'=>$model->parent,'child'=>$model->child),'confirm'=>'Are you sure you want to delete this item?')),
