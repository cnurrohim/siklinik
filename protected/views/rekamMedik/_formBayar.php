...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'resep_id',array('value'=>$modelResep->id,'readonly'=>'true')); ?>
		<?php echo $form->error($model,'resep_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'biaya_obat'); ?>
		<?php echo $form->textField($model,'biaya_obat',array('value'=>$totalBiayaObat)); ?>
